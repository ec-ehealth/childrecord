# BeVlChildReport - Child Report v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BeVlChildReport**

## Resource Profile: BeVlChildReport 

| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/be-vl-childreport | *Version*:1.0.0 |
| Active as of 2026-03-30 | *Computable Name*:BeVlChildReport |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.be.childreport|current/StructureDefinition/be-vl-childreport)
...
Other representations of profile: [CSV](StructureDefinition-be-vl-childreport.csv), [Excel](StructureDefinition-be-vl-childreport.xlsx), [Schematron](StructureDefinition-be-vl-childreport.sch) 
...
```json
{
  ...
  "url" : "https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/be-vl-childreport",
  "version" : "1.0.0",
  "name" : "BeVlChildReport",
  "status" : "active",
  "date" : "2026-03-30T14:02:17+00:00",
