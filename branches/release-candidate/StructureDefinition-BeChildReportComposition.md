# Child Report Composition - Child Report v1.0.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Child Report Composition**

## Resource Profile: Child Report Composition 

| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeChildReportComposition | *Version*:1.0.0 |
| Active as of 2026-03-30 | *Computable Name*:BeChildReportComposition |
...
* Use this Profile: [BeVlChildReport](StructureDefinition-be-vl-childreport.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.be.childreport|current/StructureDefinition/BeChildReportComposition)
