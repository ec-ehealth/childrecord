# Child Report model - Child Report v1.0.0
...
| | |
| :--- | :--- |
| *Official URL*:https://www.ehealth.fgov.be/standards/fhir/childreport/StructureDefinition/BeModelChildReport | *Version*:1.0.0 |
| Active as of 2026-03-30 | *Computable Name*:BeModelChildReport |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.be.childreport|current/StructureDefinition/BeModelChildReport)
